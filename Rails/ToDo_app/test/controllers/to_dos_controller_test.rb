...
class ToDosControllerTest < ActionController::TestCase
  ...
  test "should create to_do" do
    assert_difference('ToDo.count') do
      post :create, to_do: { done: @to_do.done, due: @to_do.due, notes: @to_do.notes, title: @to_do.title }
    end
  ...
  test "should update to_do" do
    patch :update, id: @to_do, to_do: { done: @to_do.done, due: @to_do.due, notes: @to_do.notes, title: @to_do.title }
    assert_redirected_to to_do_path(assigns(:to_do))
  end
